...
/**
 *  Tests the base class <code>Registry</code> using <code>ConcreteRegistry</code> as its 
 *  concrete subclass, and <code>SomeObject</code> as its <code>IRegistryElement</code>
 *  
 * @author Timothy Armstrong
 * @author Al Cline
 * @version <DL>
 * <DT> Build 1.0		 Jan 23 2011   // original <DD>
 * <DT> Build 1.1       May 16 2011     // TAA fixed errors <DD>
 * <DT> Build 1.2       May 23 2011     // TAA ensured all methods included <DD>
 * <DT> Build 1.3       Dec 24 2011     // ABC revamped for new Registry base clase<DD>
 * <DT> Build 1.4      Feb 25, 2013     // ABC revamped for native queries in Registry base clase<DD>
 * </DL>
 */
...
//          }
      ...
      /** MyLib.pdc.ConcreteRegistry
       * Same as testGetByKey, which is overloaded by this one
       * @Normal     Get an element by its key
       * @Normal     Change key and try to get it again
       * @Normal     Get a list of elements that have the same key
       * @throws ApplicationException is one occurs unexpectedly
