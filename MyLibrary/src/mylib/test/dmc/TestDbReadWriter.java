 ...
 *  <DT>Build 1.1 Dec 3, 2012       // updates to better distinguish openDB and closeDB <DD>
 *  <DT>Build 2.0 Feb 25, 2013     // replaced queryByExample with native queries
    ...
    //     }
        ...
        @Test
         public void testDbOpenFileExists()
         {
            MsgCtrl.auditMsgsOn(false);
            MsgCtrl.errorMsgsOn(false);
            MsgCtrl.msgln(this, "\t testDbOpenFileExists()");
    ...
    */
    @Test
     public void testDbQuery()
     {
        ...
        MsgCtrl.msgln("\tTest 1: Object match: Found " + size + " element: " + soList.get(0).toString());
        assertEquals(1, size);
        ...
        assertNotNull(soList);
        size = soList.size();
        MsgCtrl.msgln("\tTest 2: Key match: Found " + size + " elements, first of which is: " + soList.get(0).toString());
        assertEquals(2, size);
        ...
        assertNotNull(soList);
        size = soList.size();
        MsgCtrl.msgln("\tTest 4: No match  (Found " + size + " elements that compares with \"Nothng\"): ");
        assertEquals(0, size);
     ...
     *  ExtObjectContainer getDB()              simple wrapper
     *  DbOpenError()                                   don't know how to trigger the db errors 
     */
