...
/** Creates a help key (F1) listener object for triggering text to the 
 * <code>HelpDialog</code>. If the window is not open, the <code>keyPressed()</code>
 * method will open it before displaying text.
 * 
 * @author Alan Cline
 * @version <DL>
 * <DT> Build 1.0		Dec 31 2008   // moved from inner class to here <DD>
 * <DT> Build 1.1		Jan 22 2009    // made more generic for library; added owner ctor <DD>
 * </DL>
 */
public class HelpKeyListener extends KeyAdapter
{ 
	/** Contains help window reference to avoid collecting it during the 
