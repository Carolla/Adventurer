...
/**
 * Selectively controls error and output messages, and can be placed into 
 * production code. All messages to the console, normal or error, should use this
 * class for output. This static class can be accessed anywhere and wraps 
 * <code>System.out.println()</code> and <code>System.err.println()</code>, 
 * allowing messages to be turned off during unit testing; particularly useful during 
 * JUnit testing. 
 * <P>
 * The overloaded <code>msgln(Object object, String msg)</code> and
 * <code>errMsgln(Object object, String msg)</code> will provide the name of the 
 * class from which the method was called, providing a cleaner audit trail. 
 * <P>
 *  
 * @author Alan Cline
 * @version <DL>
 * <DT> Build 1.0       Jun 6, 2009     // original <DD>
 * <DT> Build 1.1       May 30, 2010   // added Object parm overloads <DD>
 * </DL>
 */
...
public class MsgCtrl
{
    ...
    /** Display a standard error message without newline;
     * used typically for constructors or statics where the <code>this</code>
     ...
     * 
     * @param obj    object that called this method; used to determine the class
