...
public class Thief extends Klass {
	...
	public enum TSKILL {
		OPEN_SECRET_DOORS, PICK_POCKETS, OPEN_LOCKS, FIND_REMOVE_TRAPS, MOVE_SILENTLY, HIDE_IN_SHADOWS, LISTENING, CLIMB_WALLS, BACK_ATTACK
	};
	 ...
	 * @param dex
	 *            of the Hero
	 * @return the list of thief skills (index = 0) with the chance of success
	 *         (index = 1)
	 */
