...
/**
 * Each Skill contains a name, description, and an associated action. Skills are
 * inherent to certain races (e.g. Elf's tingle) and klass (e.g. Rogue's Detect
 * Traps skil). Skills are also associated with certain occupations, e.g., a
 * Jeweler can "Appraise". The entire set of skills are stored in the
 * SkillRegistry for assigning to the Hero. Later, the corresponding skill
 * actions will be implemented so the Hero can use them.
 * 
 * @author Alan Cline
 * @version <DL>
 *          <DT>Build 1.0 Jan 5 2010 // original
 *          <DD>
 *          <DT>Build 2.0 May 15 2011 // TAA Added in skill2Rec and rec2Skill
 *          <DD>
 *          <DT>Build 2.1 May 22 2011 // TAA Udpated methods for testing
 *          <DD>
 *          <DT>Build 2.2 Jun 13 2011 // TAA changed to RegObject
 *          <DD>
 *          <DT>Build 2.3 FebJ10 2013 // ABC removed RegObject for db4o
 *          <DD>
 *          <DT>Build 2.4 Mar 25 2013 // ABC added in IRegistryElement
 *          <DD>
 *          </DL>
 */
public class Skill extends RegistryElement
{
    ...
    /**
     * The action that corresponds to the skill, currently implemented as a
     * String
     */
     ...
     * @param desc description of the skill, and how it might be used; cannot be
     *            null.
    ...
    /**
     * Two Skills are considered equal if their names are
     * equal. This is a required implementation for the IRegistryElement
     * interface.
     * 
     ...
     * 
     * @param skill
     *            The skill to be converted to a shuttle
