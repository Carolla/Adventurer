/*
 * Event.java Copyright (c) 2007, Carolla Development, Inc. All Rights Reserved. Permission to
 * make digital or hard copies of all or parts of this work for commercial use is prohibited.
 * To republish, post on servers, to reuse, or to redistribute to lists, requires prior
 * specific permission and/or a fee. Request permission to use from Carolla Development, Inc.
