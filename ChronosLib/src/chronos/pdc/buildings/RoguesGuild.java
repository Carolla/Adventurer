 ...
 *    The default constructor creates the default "Rogues' Den".     
 *
 * @author Alan Cline
 * @version <DL>
...
public class RoguesGuild extends Building
{
    ...
    static private final String GUILD_NAME = "Rogues' Den";
    ...
    static private final String EXTERIOR = "A rowdy bar filled with unseemly characters of the night "+
    ...
    /** The Rogues' Den opens at 9pm and closes in the wee hours at 4am.
     * This is a special case of overnight hours when the Guild closed the day after it opens,
    ...
    /** Set the business hours for this Building. This override allows the closing time to be the 
     * day after it opens. 
     * 
