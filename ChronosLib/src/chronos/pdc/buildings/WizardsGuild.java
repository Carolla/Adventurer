...
/**
 *    Wizards'Guild for spells, magical items, quests, and lodging
 *    The default constructor creates the default "Arcaneum".     
 *
 * @author Alan Cline
 * @version <DL>
...
public class WizardsGuild extends Building
{
    ...
    static private final String EXTERIOR = "An elaborate white marble edifice on the hillside contains "+
                    "one large wooden door, recessed in shadow. This is an eerie place. ";
    /** For this case, a non-Guild member cannot enter */
    static private final String INTERIOR = "A tall shrouded figure steps from the shadows as you try to "+
