...
/**
 *    Main building in town for buying and selling supplies.
 *    The default constructor creates the default "The Rat's Pack".     
 *
 * @author Alan Cline
 * @version <DL>
...
public class Store extends Building
{
    ...
    static private final String STORE_NAME = "Rat's Pack General Store";
    ...
    static private final String EXTERIOR = "The sign over the door is in good repair. A fresh coat " +
                    "of paint on the lettering spells out: " + "\"" + STORE_NAME + "\", " + OWNER + 
                    ", Proprietor. Est. 1066";
    /** What one senses when looking around the inside of the Inn when few patrons are here. */
    static private final String INTERIOR = "The store is crowded with crates of different sizes, shelves " +
