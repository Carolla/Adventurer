 ...
 * @author Alan Cline
 * @version <DL>
 * <DT> Build 1.0		Jun 8, 2009   // original <DD>
 * <DT> Build 1.1		Oct 21, 2009   // changed ctor to take int weights instead of codes <DD>
 * <DT> Build 1.2       Apr 11 2011     // TAA changed visibiltiy of attributes to protected <DD>
 * </DL>
 */
public class Item extends RegistryElement
{
    ...
    /** Increment the number of these kinds of Items in addition to it's current quanity.
     * Negative values are allowed for dropping one or more of these Items
     * 
    ...
    /** Copies like the standard <code>Object.clone()</code> method, but without all the 
     * baggage of the <code>Cloneable interface</code>. Used mostly to support the
     * Inventory copies that may damage originals added or dropped to it.
     * Will catch exceptions from the Item constructor and return a null. 
     * 
    ...
    /** Two Items are considered equal if their class, names and categories are equal. 
     * This is a required implementation for the <code>ArrayList contains()</code> method,
...
//    }
    ...
    /** 
    * Pack the Item-specific fields into a data shuttle of Strings (EnumMaps must
    * be homogeneous). Note that any existing data will be overwritten by new values
    * of the same key. 
    * 
