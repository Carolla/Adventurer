...
/**
 *   A Patron frequents the Inn of the town. He or she will reveal information about the Arena to
 *   the Hero if friendly enough, or rebuff the Hero if not. The Patron has a description when seen 
 *   from afar, and one when seen much closer up. Some Patrons will try to keep the peace if the 
 *   Hero starts a bar brawl. By default, each patron has three positive and negative mesages, and 
 *   the Buildmasters, like the Innkeeper, have more. 
 *
 * @author Alan Cline
 * @version <DL>
