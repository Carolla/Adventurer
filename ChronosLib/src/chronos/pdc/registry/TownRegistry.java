...
public class TownRegistry extends Registry {
	...
	static private final String[] DEF_BUILDING_LIST = { "Arcaneum", "Jail",
			"Monastery", "Rat's Pack", "Rouge's Den", "Stadium", "The Bank",
			"Ugly Ogre Inn" };
	 ...
	 * 
	 * @param init
	 *            flag to initialize registry for default data if true
	 */
	...
	/**
	 * Populate the TownRegistry with the default Town, and the names of the
	 * buildings and arena. Confirm that the building names represent Registry
	 * elements, and that the arena is in its own .dgn file.
	 */
	@Override
