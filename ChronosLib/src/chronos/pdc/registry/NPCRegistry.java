 ...
 *          Aug 9, 2017 // updated to support new Building: Stables <br>
 */
  ...
  static private final List<NPC> _patronTable = new ArrayList<NPC>() {
    {
      ...
      // Larry, Stables building master
      add(new NPC(
          "Larry",
          1,
          "A large man with a bulging belly and a worn clothes, but his face and hands are "
              + "well-groomed.",
          "As you approach, he puts his hand on one hip, \"Looking for work? Or a place to sleep?\"",
          // rumors
          new ArrayList<String>() {
            {
              add("\"Name's Larry, like the sign says.\" He points to the big weather beaten sign "
                  + "over the barn door: 'Larry's Livery'");
              add("\"If you want, you can muck the stalls for 1 gp a night. You can sleep here "
                  + "at no cost. Food can be had at the Inn next door.");
              add("\"I was just like you once: foolish drifter looking for glory and gold.\" "
                  + "He scratches his stubbly chin. \"Well, you can see where I wound up, and am "
                  + "not sad for it. I make ends meet and can help other foolish drifters like "
                  + "you.\"");
            }
          },
          // retorts
          new ArrayList<String>() {
            {
              add("\"You don't look like you can afford a horse, if you even know how to ride "
                  + "one. Need a place to sleep, I'm guessing.\"");
              add("\"I can't affort hand outs, but you can muck the stalls for 1 gold piece a "
                  + "night, and if you're not a loaf-about and can do a good night's work.\"");
              add("\"Take it or leave it! I have work to do, and if you steal my livestock, "
                  + "I'll track you down and hang your entrails over my door.\"");
            }
          }));
