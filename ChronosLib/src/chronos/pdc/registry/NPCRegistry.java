...
{
    /** Field names for each NPC in the default NPC list of the init table
     * NAME of the Non-Player Character,
     * NOTE: -profession of the NPC as a note to the author 
     * AFFINITY: -5 to+5 int adjustment to friendliness when talking with Hero 
     * PEACEKEEPER: "true" if NPC is a peacekeeper in the Inn, else "false", 
     * FAR DESCRIPTION: what Hero sees of the NPC from a distance
     * NBR_RUMORS: The number of positive messages the NPC has
     * NBR_RETORTSs: The number of negative messages the NPC has
     * FAR DESCRIPTION: what Hero sees of the NPC from a distance
     * NEAR DESCRIPTION. what the Hero sees close-up of the NPC
     * RUMOR_LIST: A list of positive messages that the NPC may reveal
     * RETORT_LIST: A list of negative messages that the NPC may reveal
     */
    private enum Index  {NAME, NOTE, AFFINITY, PEACE, NBR_RUMORS, NBR_RETORTS,
            FAR_DESC, NEAR_DESC};
    
    /** Index position where the variable rumor list starts */
    private final int RUMORS_START = 7;
    
    /** The default init table containing starting Non-Player Characters
     * 16 NPCs in table */
    static private final String[][] _patronTable = {
            // Sal the cobbler
            {"Sal", "cobbler", "-1", "false", "3", "3",
            ...
            {"Meladriel", "courtesan", "5", "false", "3", "3",
            ...
            {"Aragon", "Captain of the Guard", "-3", "true", "3", "3",
            ...
            { "Balthazar", "Monastery Master", "3", "true", "3", "3",
            ...
            {"Pendergast", "Arcaneum Master", "0", "false", "3", "3",
            ...
            {"Ripper", "Rogues' Den Master", "0", "F", "3", "3",
            ...
            {"Loren", "Stadium Master", "1", "true", "3", "3",
            ...
            {"Bork", "Innkeeper for Ugly Ogre Inn", "1", "true", "6", "3",
            ...
            {"J.P. Pennypacker", "Bank manager", "0", "F", "3", "3",
            ...
            {"Dewey N. Howe", "General Store Owner", "3", "F", "3", "3",
            ...
            {"The Sheriff", "Jail Master", "-2", "true", "3", "3",
    ...
    /**
     * Creates the Patron Registry with the static tables given, converting
     * each element to a Patron and saving it in the Patron Registry. 
     */
    @Override
