...
/**
 * Contains a set of Adventure objects, where each Adventure contains the name of a Town
 * and an Arenda
 * 
 * @author Alan Cline
...
//    }
    ...
    /**
     * Create the default Adventure Registry, containing only a single Adventure
     * it is called by the base <code>Registry</code> class 
     */
    @Override
    protected void initialize()
    {
        ...
        Adventure adv = new Adventure(
                        DEF_ADVENTURE, DEF_TOWN, DEF_ARENA, DEF_OVERVIEW); 
