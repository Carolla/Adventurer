...
/**
 * Contains a set of occupations and associated Skills that a player may assign
 * to his Hero. It also contains a method to allow more occupations to be added.
 * <code>OccupationRegistry</code> is a read-only singleton and is only
 * initialized once.
 * 
 * @author Alan Cline
 * @version <DL>
 ...
 *          <DD>
 *          <DT>Build 1.1 Jan 9 2010 // simplified by removing Occupation class
 *          and using a String[][] table directly.
 *          <DD>
 *          <DT>Build 2.0 Feb 5 2011 // TAA: converted to OccupRegistry
 *          <DD>
 *          <DT>Build 2.1 Apr 11 2011 // TAA renamed occReg to thisReg
 *          <DD>
 *          <DT>Build 2.2 May 14 2011 // TAA fixed some bugs
 *          <DD>
 *          <DT>Build 3.0 Jun 13 2011 // Redesigned to use load method from file
 *          <DD>
 *          <DT>Build 3.1 Nov 4 2011 // ABC Few minor bugs to stop recursive
 *          loading, and to use the Chronos library file for pathing
 *          <DD>
 *          <DT>Build 3.2 May 13 2012 // TAA updated initTables method
 *          </DL>
 */
public class OccupationRegistry extends Registry
{
    /**
     * Use this table to init the OccupTable with the occupation and skill
     * names. Put occupations into alphabetical order, which is how the names
     * will be displayed. Each skill must be in the SkillRegistry. See the
     * SkillRegistry for a definition of what each of the Skills does.
     * 28 Occupations in table
     */
    ...
    /**
     * Creates the Occupation Registry with the static tables given, converting
     * each element to an Occupation object and saving it in the database. Each
     * Occupation has a Skill that must exist in the Skill registry, so this also is checked.
     */
    @Override
     ...
     * @throws ApplicationException if the Skill does not exist in the Skill Registry, 
...
//    }
    ...
    /**
     * Verify that an Occuational skill exists in the Skill registry, or this
     * Occupation is invalid. To verify against the database, a Skill object is
     * created with the matching skillname. This is required because the
     * registry matches by example.
     * 
    ...
    /*
     * ++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
     *         INNER CLASS: MockOccupationRegistry for Testing
     * ++++++++++++++++++++++++++++++++++++++++++++++++++++++
     */
