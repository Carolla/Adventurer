...
public class OccupationRegistry extends Registry<Occupation>
{
  ...
  private static final List<Occupation> _occupTable = new ArrayList<Occupation>() {{
    add(new Occupation("Academic", "Knows diverse information, court politics and bureaucrats.", "INT+1",
    ...
    add(new Occupation("Acrobat", "Acrobatic and aerial body control.", "DEX=16", 
        new ArrayList<String>() {{ add("Climb Walls"); add("Balance"); add("Escape Artist"); add("Jump"); add("Tumble");}}));
    ...
    add(new Occupation("Apothecary", "Knows herbs, ointments, and medicines. Owns Alchemists' Kit.", "WIS+1", 
        new ArrayList<String>() {{ add("Natural Knowledge");}}));
    add(new Occupation("Armorer", "Makes and repairs metal armor, helmets and shields. Owns Metalsmith Kit.", "STR+1", 
    ...
    add(new Occupation("Carpenter", "Knows wood and woodworking tools. Owns Woodworking Kit.", "STR+1", 
    ...
    add(new Occupation("Fisher", "Knows about bodies of fresh water and lakes. Owns Sewing Kit.", "STR+1",
    ...
    add(new Occupation("Forester", "Has natural knowledge in wooded areas.", "STR=15;DEX=16", 
        new ArrayList<String>() {{ add("Hide in Shadows"); add("Move Silently"); add("Wilderness Lore"); add("Intuit Outdoor Direction"); add("Spot Details");}}));
    add(new Occupation("Freighter", "Businessman. Ships cargo in wagons. Owns Woodworking Kit.", "WIS+1", 
        new ArrayList<String>() {{ add("Negotiations"); add("Cargo Transport"); add("Train Animals");}}));
    add(new Occupation("Gambler", "Skilled in games of chance.", "DEX=16;CHR=16", 
        new ArrayList<String>() {{ add("Luck"); add("Pick Pockets"); add("Open Locks"); add("Bluff"); add("Sense Motive");}}));
    add(new Occupation("Hunter", "Tracks and kills wild animals for food", "DEX=15;CON=16",
        new ArrayList<String>() {{ add("Hunting"); add("Find/Set Traps"); add("Move Silently"); add("Hide in Shadows"); add("Spot Details"); add("Intimidate"); add("Listening");}}));
    add(new Occupation("Husbandman", "Knows livestock of all kinds (horses, sheep, cattle, pigs)", "WIS+1",
        new ArrayList<String>() {{ add( "Husbandry"); add("Animal Empathy"); add("Train Animals");}}));
    add(new Occupation("Innkeeper", "Businessman. Runs crowded places, people-oriented, business-savvy", "CHR=16",
        new ArrayList<String>() {{ add( "Negotiations"); add("Sense Motive"); add("Gather Information"); add("Read Lips");}}));
    add(new Occupation("Jeweler", "Recognizes true value of gems, jewelry, etc. Works intricate devices like a watchmaker.", "DEX+1", new ArrayList<String>() {{ add("Appraise Jewelry"); add("Open Locks");}}));
    add(new Occupation("Leatherworker", "Tans hides and makes leather items. Owns Leatherworking Kit", "CON+1",
    ...
    add(new Occupation("Mason", "Constructs buildings, works mortar, lays brick; knows stonework.", "STR+1;WIS+1",
        new ArrayList<String>() {{ add( "Find Secrets in Stonework");}}));
    add(new Occupation("Miner", "Digs ores from caverns and mines. Knows kinds of rock and ores", "STR+1",
        new ArrayList<String>() {{ add( "Intuit Underground Direction"); add("Cavern Lore"); add("Find Secrets in Stonework");}}));
    add(new Occupation("Navigator", "Knows direction at sea, plots water course without getting lost", "WIS+1",
        new ArrayList<String>() {{ add( "Predict Weather"); add("Water Lore"); add("Intuit Outdoor Direction"); add("Spot Details"); add("Fast Swim");}}));
    ...
    add(new Occupation("Shipwright", "Builds ships, knows wood and wood-working tools.", "STR+1;CON+1",
        new ArrayList<String>() {{ add( "Make Raft"); add("Fast Swim");}}));
    ...
    add(new Occupation("Trader", "Businessman. Familar with transport equipment.", "CHR+1",
        new ArrayList<String>() {{ add( "Financial Brokering"); add("Sense Motive"); add("Diplomacy");}}));
    add(new Occupation("Trapper", "Catches animals for tanning or money.", "DEX=17",
        new ArrayList<String>() {{ add( "Trapping"); add("Find/Set Traps"); add("Move Silently"); add("Open Locks"); add("Hide in Shadows"); add("Spot Details"); add("Wilderness Lore"); add("Disable Device Skill");}}));
    add(new Occupation("Weaponsmith", "Knows metal weapons of all types and metalworking. Owns Metalsmith Kit.", "STR+1",
        new ArrayList<String>() {{ add( "Make Weapons");}}));
    add(new Occupation("Weaver", "Makes tapestries, rugs, bed clothing. Knows dyes. Owns Sewing Kit", "DEX+1;WIS+1",
        new ArrayList<String>() {{ add( "Appraise Tapestries");}}));
    add(new Occupation("Woodworker", "Builds wood furniture, cabinets. Knows wood and wood-working tools. Owns Woodworking Kit.", "STR+1;INT+1",
        new ArrayList<String>() {{ add( "Woodworking"); add("Find Secrets in Woodwork"); add("Disable Device Skill");}}));
    add(new Occupation("Drifter", "Everyone is running from something. What's your story?", "WIS+3;CHR+2",
