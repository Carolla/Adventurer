 ...
 * that get treated like Items.  
 * <code>ItemRegistry</code> is a read-only singleton and is only initialized once.
 * 
 * @author Tim Armstrong
 *  * @version <DL>
 * <DT> Build 1.0       Apr 13, 2012    // original <DD>
 * <DT> Build 1.1       Dec 31, 2012    // updated to follow other Registries and db4o<DD>
 * <DT> Build 2.0       Feb 12, 2013   // updated to allow all items for all registries<DD>
 * <DT> Build 2.1      May 6,  2013   // updated getInstance(boolean) <DD>
 * </DL>
 */
public class ItemRegistry extends Registry
{

    /** 14 Starting Items, and weight in ounces, for the Hero's inventory:
...
//    private ItemRegistry(boolean init) 
    ...
    /**
     * Create the Item Registry with the tables given, converting each element
     * to a Item object and saving it in the database.
     */
    @Override
