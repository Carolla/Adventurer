...
import chronos.civ.MiscKeys.HeroOptions;
...
public class _DefaultLists
{
   ...
   * 
   * @param label that identifies the options list in the object
   * @return DefaultList that can be stored in the registry and db
   * */
  public _DefaultLists(HeroOptions label)
  {
    _label = label;
    _option = null;
    _quantity = null;
   ...
   * 
   * @param label that identifies the options list in the object
   * @param opts the options for the Hero, which may be Strings or Items
   * @return DefaultList that can be stored in the registry and db
   * */
  public _DefaultLists(HeroOptions label, String[] opts)
  {
    _label = label;
   ...
   * @return DefaultList that can be stored in the registry and db
   * */
  public _DefaultLists(HeroOptions label, ArrayList<String> opts, ArrayList<Integer> qty)
  {
    _label = label;
