/**
 * SkillKeys.java Copyright (c) 2011, Carolla Development, Inc. All Rights Reserved
 * 
...
/**
 * Contains the WidgetKeys for a DataShuttle MVP Stack. These two key sets, and the DataShuttle
 * class, must be in the Civ package because both the HIC and PDC packages must access them. Each
 * key has its own validation routine so there is one and only one place for validation.
 * 
 * @author Timothy Armstrong
 * @version Sept 5, 2011 // original <br>
 */
