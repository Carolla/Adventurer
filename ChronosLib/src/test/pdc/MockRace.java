/**
 * MockRace.java Copyright (c) 2009, Carolla Development, Inc. All Rights
 * Reserved
 * 
...
public class MockRace extends Race {
	...
	/**
	 * Each subclass prepares a description based on height ranges, then calls a
	 * generic rangeDescriptor method implemented in this base class.
	 */
	...
	/**
	 * Each subclass prepares a description based on weight ranges, then calls a
	 * generic rangeDescriptor method implemented in this base class.
	 */
	...
	/*
	 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ TEST
	 * RACE METHODS THAT ARE IMPLEMENTED ONLY IN BASE CLASS
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 */
	...
	/**
	 * Run the given traits through the various starting sets for male and
	 * female
	 * 
	 * @param traitList
	 *            simulated traits
	 * @param gender
	 *            male or female (male is not adjusted)
	 * @return given traits adjusted by age category
	 */
	 ...
	 * 
	 * @param ap
	 *            Action Points (AP) determine Person's speed
	 * @param height
	 *            gives bonus or penalty adjustment
	 ...
	 */
	public String testRangeDescriptor(double value, double minValue,
			double maxValue, String[] descriptors) {
		return super
				.findRangeDescriptor(value, minValue, maxValue, descriptors);
	}
