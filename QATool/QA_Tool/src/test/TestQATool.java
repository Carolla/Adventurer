...
public class TestQATool
{
   ...
   static private final String ROOT =
         System.getProperty("user.dir") + Constants.FS + "QATestbed" + Constants.FS + "src";
