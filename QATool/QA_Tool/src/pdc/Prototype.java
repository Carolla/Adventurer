...
public class Prototype
{
   ...
   private final String AUGMENT_VERSION =
         "*          %1$tB %1$te, %1$tY \t// autogen: added missing test methods <br>";
   ...
   // /**
   // * Adds new test methods to an existing test file
   // *
   // * @param existingFile target test file to augment
   // * @param mlist list of methods to add to the test file
   // * @return the test file written
   // */
   // public File augmentFile(File existingFile, ArrayList<String> mlist)
   // {
   // // For readability, remove the root prefixes but keep the subdir references
   // String targetPath = existingFile.getPath();
   // // int cutPoint = targetPath.indexOf("test");
   // // String shortName = targetPath.substring(cutPoint);
   // // System.out.println("\tAugmenting test class file " + shortName);
   //
   // // Rename the target file for copying
   // targetPath = targetPath.replace(".java", ".intmp");
   // File destFile = new File(targetPath);
   //
   // // Create new input and output devices
   // PrintWriter out = null;
   // Scanner in = null;
   // try {
   // // Ensure that the target file exists
   // in = new Scanner(existingFile);
   // out = new PrintWriter(destFile);
   // } catch (FileNotFoundException e) {
   // System.err.println("\taugmentFile(): \t" + e.getMessage());
   // return null;
   // }
   // // Copy old file to new
   // System.out.println("\n\nAUGMENTATION ECHO CHECK:");
   // while (in.hasNext()) {
   // String s = in.nextLine().trim();
   // out.println(s);
   // // System.out.println(s);
   // // Add another version statement after the first
   ...
   // }
   // }
   // // Before the file is closed, append the new methods
   // writeCodeBlocks(out, mlist);
   //
   //
   // in.close();
   // out.close();
   ...
   // String renamed = targetPath.replace(".intmp", ".java");
   // File augFile = new File(renamed);
   //
   // return augFile;
   //
   // }
