...
public class AttributeList
{
   ...
   * 
   * @param attList the attributes for the list
   */
  public AttributeList(int[] attList)
  {
    assert(attList.length == NUM_ATTRIBUTES) : "Invalid attribute list: " + attList;
    atts = new TreeMap<ATTRIBUTE, Integer>();
   ...
   * 
   * @param att the attribute being added/updated
   * @param i the value to put into the list
  ...
  /**
   * Based on the ordering specified for attributes, returns the value of an attribute from the list
   * 
   * @param i position in the list to return
   ...
   * @param val the value to put into the list
