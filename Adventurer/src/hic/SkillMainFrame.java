 ...
 *  @version <DL>
 * <DT>1.0		Aug 15 2011	 		// original- adapted 	<DD>
 * </DL>
*/
public class SkillMainFrame extends JFrame
{
	/** Generated UID     */
    private static final long serialVersionUID = 6497748833487097470L;
 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++ */  
	...
	static private SkillMainFrame _mainframe = null;
	...
	public static void main(String[] args)
	{
        ...
        EventQueue.invokeLater(new Runnable()
        {
    		...
    		{	
    			...
    			SkillMainFrame frame = SkillMainFrame.getInstance();
    			// Calls the inner class Terminator WindowEvent Listener instead 
    			frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    			
    			SkillDialogue skDlg = new SkillDialogue(frame);
    			skDlg.setVisible(true);
 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++ */  
     ...
     */
    public static  SkillMainFrame getInstance()
    {
        if (_mainframe == null) {
            _mainframe = new SkillMainFrame();
        }
        return _mainframe;
    }
