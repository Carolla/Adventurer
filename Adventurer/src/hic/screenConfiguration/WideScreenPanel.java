...
{
  /* private constants */
  private static final String IMAGE_PATH = Chronos.ADV_IMAGE_PATH;
  ...
  public WideScreenPanel()
  {
    ...
    /*
     * As indicated by the previous output, the constraints do not factor out to actual pixel
     * dimensions on the components, therefore extra measures must be taken to acquire the proper
     * dimensions to use on the component being added to it's MigLayout constrained parent.
     */
    ...
    // int imgWidth = (getContentPane().getSize().getWidth() * appPanMult * uImgPanMult *
    // imgPanMult);
