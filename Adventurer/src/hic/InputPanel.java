/**
 * InputPanel.java Copyright (c) 2013, Carolla Development, Inc. All Rights Reserved
 * 
...
/**
 * This class serves as the background frame for all GUI activities. It contains the MainFrame
 * class, the NotImplemented class, and the About Dialog.
 * 
 * @author Alan Cline
 * @version <DL>
 *          <DT>1.0 Feb 18, 2013 TAA Initial object
 *          </DL>
 */
...
public class InputPanel extends JPanel
{
     ...
     */
    public InputPanel(CommandParser parser) {
        _cp = parser;
    ...
    private JScrollPane createOutputPanel()
    {
        ...
        scrollPane.setPreferredSize(new Dimension(winHeight,
                winWidth));
     ...
     * sends its bytes to the output text area
     * 
