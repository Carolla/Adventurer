...
/**
 * The {@code ImagePanel} class extends {@code ChronosPanel} so that it is easy to draw onto.
 * It is a singleton because it is created once and different images are displayed on it for
