...
//  }
   ...
   * 
   * @param _summonableHeroes the list of Hero names
   */
  @SuppressWarnings({"unchecked", "rawtypes"})
  public ShuttleList(List<Hero> _summonableHeroes)
  {
...
//              ((DefaultListModel) _rightList.getModel()).addElement(selectedItem.toString());
      ...
      getContentPane().add(buttonPane, BorderLayout.SOUTH);
      {
        ...
        _okButton.addActionListener(new ActionListener()
        {
          ...
          public void actionPerformed(ActionEvent arg0)
          {
            ...
            List<Hero> selItems = ShuttleList.this
                .getSelectedItems();
            System.out.print("\nElements selected: ");
   ...
   */
  @SuppressWarnings({"unchecked", "rawtypes"})
  public ShuttleList(List<Hero> _summonableHeroes, List<Hero> _partyHeros)
  {
    this(_summonableHeroes);
    for (Hero s : _partyHeros) {
   ...
   */
  public List<Hero> getSelectedItems()
  {
    int numElts = _rightList.getModel().getSize();
    List<Hero> list = new ArrayList<Hero>(numElts);
    for (int i = 0; i < numElts; i++) {
      list.add((Hero)_rightList.getModel().getElementAt(i));
    }
    return list;
  }
