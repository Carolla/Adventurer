/**
 * OccupationDialogue.java Copyright (c) 2009, Carolla Development, Inc. All Rights Reserved
 * 
...
public class OccupationDialogue extends JDialog
{
  ...
  private void buildFrame()
  {
    ...
    // Row 1
    _occPanel = buildOccupationComboBox(_occList.toArray(new String[_occList.size()]));
    contentPane.add(_occPanel);
    _namePanel = buildNamePanel("Occupation Name");
    contentPane.add(_namePanel, "wrap");

    // Row 2
    _skillPanel = buildSkillComboBox(_skilllist.toArray(new String[_skilllist.size()]));
