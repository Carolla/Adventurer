 ...
 *          </DL>
 */
public class TestFileLocation extends TestCase
{
    ...
    private final String PERSON_LOCATION = "/Projects/workspace/Adventurer/resources/user/dormitory/";
     ...
     * @Error n/a
     */
    public void test_HeroDisplayCiv() throws InstantiationException
    {
        MsgCtrl.auditMsgsOn(false);
        MsgCtrl.errorMsgsOn(false);
        MsgCtrl.msgln(this, "\ttest_HeroDisplayCiv()");
    ...
    public void testSavePerson()
    {
        ...
        assertFalse(_civ.savePerson(false));
    }

    /**
     * Called when the model is updated to update the display
     * <code>    public void update(Observable model, Object ignore)</code>
     */
    public void testUpdate()
    {
        MsgCtrl.auditMsgsOn(false);
        MsgCtrl.errorMsgsOn(false);
        MsgCtrl.errMsgln(this, "Test not yet implemented.\t"
                + "update(Observable model, Object ignore)");
    }
     ...
     * <code>isValid(DataShuttle<NewHeroFields>)</code>: -- unused override <br>
     */
...
//  Used to demo testing technique; can be deleted    
//    public void testValidate()
//    {
//        assertFalse(validateName(null));
//        assertFalse(validateName("  ")):
//        assertFalse(validateName("John Smith"));
//        assertTrue(validateName("Fred Kadiddlehopper"));
//        
//        assertFalse(validatePosMsg(null));
//        assertFalse(validatePosMsg("  ")):
//        assertFalse(validateName("John Smith"));
//        assertTrue(validateName("Fred Kaddidlehopper"));
//        
//    }
//    
//    private boolean validateName(String target)
//    {
//        return civ.validate(target, NEAR_DESC, FAR_DESC, POSMSGS, NEGMSGS);
//    }
//    
//    
//    private boolean validatePosMsg(ArrayList<String> mlist)
//    {
//        return civ.validate(NAME, NEAR_DESC, FAR_DESC, mlist, NEGMSGS);
//    }
