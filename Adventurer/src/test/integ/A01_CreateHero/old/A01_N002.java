 ...
 *          </DL>
 */
public class A01_N002 extends TestCase {
    ...
    private final String IP_NAME = "Sherrida D'Wora";
    private final String IP_GENDER = "Female";
    private final String IP_HAIRCOLOR = "brown";
    private final String IP_RACENAME = "Dwarf";
    private final String IP_KLASSNAME = "Peasant";
    private final String IP_OCCUPATION = "Hunter";
    ...
    private final String[] OP_LANGUAGES = { "Common", "Dwarven" };
