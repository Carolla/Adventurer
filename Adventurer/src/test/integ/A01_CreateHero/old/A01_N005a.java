 ...
 *          </DL>
 */
public class A01_N005a extends TestCase {
    ...
    private final String IP_NAME = "Jonathan Goodapple";
    ...
    private final String IP_OCCUPATION = "Carpenter";
    ...
    private final String[][] OP_SKILLS = {
            { "Find Secret Doors in Wood",
                    "+10% chance to find secret doors in wood surfaces" },
