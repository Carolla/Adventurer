 ...
 *          </DL>
 */
public class A01_N004 extends TestCase
{
    ...
    private final String IP_NAME = "Annabell Tink";
    private final String IP_GENDER = "Female";
    private final String IP_HAIRCOLOR = "brown";
    private final String IP_RACENAME = "Gnome";
    private final String IP_KLASSNAME = "Peasant";
    private final String IP_OCCUPATION = "Apothecary";
    ...
    private final int OP_HEIGHT = 53;
    private final int OP_WEIGHT = 120;
    ...
    private final String[] OP_LANGUAGES = { "Common", "Gnomish" };
    private final int OP_MAX_LANGS = 2; // for INT = 12

    // Row 5: Description of the new Hero
    private final String OP_DESCRIPTION = "A pudgy female with brown hair. She is weather-beaten and tough.";

    // Skill Tab
    private final String[][] OP_SKILLS = {
            { "Natural Knowledge",
                    "+1 WIS chance to identify substance or potion" },
            { "Infravision 60'", "Can see warm bodies in the dark" },
            { "Geasing",
                    "Able to detect undeground direction and stone-based traps" } };

    // Inventory tab
    private final String[] OP_ITEMS = { "Backpack", "Belt", "Breeches",
            "Shirt", "Rations", "Quarterstaff" };
