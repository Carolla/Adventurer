 ...
 *          </DL>
 */
public class A01_N003a extends TestCase {
    ...
    private final String IP_NAME = "Aearehwelnyn";
    private final String IP_GENDER = "Male";
    private final String IP_HAIRCOLOR = "blonde";
    private final String IP_RACENAME = "Elf";
    private final String IP_KLASSNAME = "Peasant";
    private final String IP_OCCUPATION = "Leatherworker";
