 ...
 *          </DL>
 */
public class A01_N006 extends TestCase {
    ...
    private final String IP_NAME = "Thurkla";
    private final String IP_GENDER = "Female";
    private final String IP_HAIRCOLOR = "brown";
    private final String IP_RACENAME = "Half-Orc";
    private final String IP_KLASSNAME = "Peasant";
    private final String IP_OCCUPATION = "Forester";
    ...
    private final String[] OP_LANGUAGES = { "Common", "Orcish" };
