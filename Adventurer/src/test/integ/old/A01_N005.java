 ...
 *          </DL>
 */
public class A01_N005 extends TestCase {
    ...
    private final String IP_NAME = "Jarae Windbearer";
    private final String IP_GENDER = "Female";
    private final String IP_HAIRCOLOR = "brown";
    private final String IP_RACENAME = "Half-Elf";
    private final String IP_KLASSNAME = "Peasant";
    private final String IP_OCCUPATION = "Bowyer";
    ...
    private final String[] OP_LANGUAGES = { "Common", "Elven" };
