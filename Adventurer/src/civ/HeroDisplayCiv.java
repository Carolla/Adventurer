...
/**
 * Output Civ: Creates the GUI widget <code>HeroDisplay</code>, passing output
 * data to it, which then formats and displays the Person data because the GUI
 * has no knowledge of PDC objects.
 * 
 * @author Alan Cline
 * @version <DL>
 *          <DT>Build 1.0 May 31 2010 // original
 *          <DD>
 *          <DT>Build 2.0 Jul 4 2010 // segregated HIC from PDC
 *          <DD>
 *          <DT>Build 2.1 Jan 4 2011 // removed Observer MVP model approach
 *          <DD>
 *          </DL>
 */
public class HeroDisplayCiv 
{
    ...
    private DataShuttle<PersonFileData> _fileData = null;
    ...
    /**
     * Creates the Civ and its associated output HeroDisplay widget Do not
     * display the GUI if this is in JUnit test
     * 
     * @param person
     *            the model object from which to get the display data
     */
     ...
     * 
     * @param name
     *            the name of the person to be summoned
     */
    ...
    /**
     * Save the Person to a new file. This method pops up a file chooser so the
     * user can select a filename; else the Hero's name is used. If the Person
     * is newly created, then the Person is saved to a new file. If the Person
     * already existed, then no file writes are written because the
     * <code>HeroDislay</code> panel does not allow edits; Save As options are
     * disabled.
     * 
     * @return true if the save worked correctly
     */
    public DataShuttle<PersonFileData> getPersonFileData() {
        MsgCtrl.msgln(this, "\tsavePerson(): ");

        // Get the requested key data map needed for the chooser from the CIV
        _fileData = new DataShuttle<PersonFileData>(PersonFileData.class);
     ...
     * 
     * @param ds
     *            shuttle containing internally formatted key values
     ...
     * 
     * @param skills
     *            list of Hero's skills to display
     * @return false is an error occurs
     */
     ...
     * 
     * @param saveName
     *            filename to use for saving the Person
    ...
    /**
     * Load all person names from the database Method made static because in
     * order to create a HeroDisplayCiv, a person or person name is needed,
    ...
    /**
     * Convert the Item objects into string fields for list display. All Item
     * fields are concatenated into a single delimited string.
     * 
     * @param items
     *            list of Item object to convert
    ...
    /**
     * Convert the Skill object into string fields for list display. All Item
     * fields are concatenated into a single delimited string.
     * 
     * @param skills
     *            list of Skills objects to convert
     * @return the string list of output data
     */
    ...
    public class MockHeroDisplayCiv {
         ...
         * @return data shutle
         */
        public DataShuttle<PersonKeys> getDataShuttle() {
