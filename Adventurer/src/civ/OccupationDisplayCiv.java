...
/**
 * Output Civ: Will create a GUI widget <code>SkillDisplay</code>, passing
 * output data to it, which then formats and displays the data because the GUI
 ...
 *          </DL>
 */
public class OccupationDisplayCiv extends
        BaseCiv<OccupationKeys, OccupationKeys> implements Observer {
    /** Occupation Registry */
     ...
     * 
     * @param occName
     *            the name of the occupation to be deleted
     ...
     * 
     * @param occName
     *            name of the occupation to be populated
     * @return data shuttle packed with information of occupation named in
     *         parameter
     */
    public DataShuttle<OccupationKeys> getOccupation(String occName) {
     ...
     * 
     * @param ds
     *            Shuttle packed with data for validation
     * @return True if the values are acceptable
     */
    @Override
    public DataShuttle<OccupationKeys> isValid(DataShuttle<OccupationKeys> ws) {
     ...
     * 
     * @param shuttle
     *            in/out shuttle containing the model/widget data
     * @return shuttle containing widget String data
     */
    @Override
    public DataShuttle<OccupationKeys> convertToDisplay(
            DataShuttle<OccupationKeys> shuttle) {
     ...
     */
    @Override
    public DataShuttle<OccupationKeys> convertToModel(
            DataShuttle<OccupationKeys> shuttle) {
        // Guard: if shuttle is null, return false immediately
        if (shuttle == null) {
            return null;
    ...
    /**
     * Accept data in a shuttle, verify that it is correct, and create a new
     * occupation from the data input. Add into the OccupationRegistry
     * 
    ...
    /**
     * Accept data in a shuttle, verify that it is correct, and create a new
     * occupation from the data input. Add the occupation into the ORegistry
     * 
     * @param _ds
     *            Shuttle containing the fields for occupation to be validated
     * @return data (widget) shuttle with error modes set
     */
    @Override
    public DataShuttle<OccupationKeys> submit(DataShuttle<OccupationKeys> ws) {
        _ds = convertToModel(ws);
     ...
     * 
     * @param myObject arbitary object that the observable model passes to this
     * observer
     */
