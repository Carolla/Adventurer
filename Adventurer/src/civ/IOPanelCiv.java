/**
 * IOPanelCiv.java Copyright (c) 2015, Carolla Development, Inc. All Rights Reserved
 * 
...
/**
 * @author Al Cline
 * @version May 10, 2016 // original <br>
 */
public class IOPanelCiv
{
  ...
  /**
   *  Handles the user's input (CmdLine parser) and output (transcript section) 
   */
