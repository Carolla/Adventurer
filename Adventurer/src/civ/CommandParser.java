...
public class CommandParser
{
    ...
    private final String[][] _cmdTable = {
            ...
            { "EXIT", "CmdExit" },                  // Leave the building   
            { "RETURN", "CmdReturn" },     // Return to Town   
...
//            { "WAIT", "CmdWait" }, 				// Wait a specific amount of time, in hours or minutes.
    ...
    /** 
     * Constructor which also creates an ArrayList for command-specific parms sent to 
     * a Command, and a <code>CommandFactory</code>.
     *  
     * Creates or returns the <code>CommandParser</code> reference. 
     * A <code>CommandFactory</code> is created as part of this class to funnal activity
     * through <code>CommandParser</code>.
     * The <Scheduler> is also created on its own threa to handle the commands
     * 
...
//        _userInput = "Enter";
    ...
    /** TODO: Add in the Help window later */
//    /** 
