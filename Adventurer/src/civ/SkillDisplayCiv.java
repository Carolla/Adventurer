...
public class SkillDisplayCiv extends BaseCiv<SkillKeys, SkillKeys> implements
    ...
    /**
     * Define the kinds of classes a Hero might be (first one is default):
     ...
     * 
     * @param skillName
     *            the name of the skill to be deleted
     ...
     * 
     * @param skillName
     *            name of the skill to be populated
     ...
     */
    @Override
    public DataShuttle<SkillKeys> convertToDisplay(
            DataShuttle<SkillKeys> shuttle) {
        ...
        // ds.setErrorMessage(DataShuttle.MISSING_KEY_MSG + key);
        // break;
        // }
        // }
     ...
     * skill from the data input. Add the skill into the SkillRegistry
     * 
     ...
     * 
     * @param _ds
     *            Shuttle containing the fields for skill to be validated
     * @return data (widget) shuttle with error modes set
     */
    @Override
    // public DataShuttle<SkillKeys> submit (DataShuttle ds)
