 ...
 * @author Alan Cline
 * @version <DL>
 *          <DT> Build 1.0 May 27 2010 // original <DD> <DT> Build 2.0 Jul 3
 *          2010 // support input CIV and EnumMap <DD> <DT> Build 2.1 Sep 6 2011
 *          // refactored for MVP Stack <DD> <DT> Build 2.2 Jan 4 2012 //
 *          refactored Observer pattern back out <DD>
 *          </DL>
 */
public class NewHeroCiv {
    ...
    { "bald", "black", "blonde", "brown", "gray", "red", "silver", "streaked",
            "white" };
	...
	/**
	 * Validates the data and reformats it for the PDC object. This method
	 * validates the data in the widget shuttle, converts it to model shuttle
	 * data, and calls the model's <code>unloadShuttle()</code> method to store
	 * the data.
	 * 
	 * @param ws
	...
	/**
	 * Transfer the input data from the widget shuttle to the model shuttle. For
	 * new Heroes, there are no keys that need to go back to the model; they are
	 * provided in the Person constructor.
	 * 
	 * @param ws
	 *            shuttle containing widget string data
	...
	/**
	 * Overrides the base class's do-nothing localAction() to create a new
	 * model. The output observer Civ is created to receive the update data from
	 * the model later.
	 * 
	 * @param inMap
	...
	private class AbilityScoreSelector {
		...
		/**
		 * Set Max and Min values for the control. Called from the constructor and from the UI
		 * when race or gender changes.
		 */
