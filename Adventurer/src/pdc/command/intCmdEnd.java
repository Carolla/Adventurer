...
/**
 *	This internal command indicates the end of execution of a user command. 
 *	It's <code>exec()</code> method tells the Scheduler to get another user command.
 * This command is created each time a user command is created and put on the Schedule queue as an event after the
 * duration of the user command.
 * @author Alan Cline
 * @version <DL>
 * <DT>1.0		Aug 29	2006 		// original <DD>
 * <DT>2.0		Oct 26		2007		// revised when DgnRunner and DgnBuild were merged <DD>
 * <DT>3.0		Jan 15 		2007		// grouped all internal (non-user) commands together <DD>
...
public class intCmdEnd extends Command
{
	...
	/** An internal command to trigger getting another user command. It cannot be called by 
	 * the user. */
 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++ */  
    ...
    /**
     * Loads up default values that may be overwritten, depending on the previous command.
     * The previous Command's duration is this intCmdEnd's delay, and must be overridden by the init() method
     */
    public intCmdEnd() 
    {
    ...
    /**
     * Creates an intCmdEnd with a new delay based on the user command it is ending.
     * The previous Command's duration is this intCmdEnd's delay
     * 
 ...
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++ */  
    ...
    /**
     * Takes the previous Command's duration as String args[0] and converts it to a base
     * class attribute <code>Command._delay</code>. Unlike the user command, does not 
     * create a paired intCmdEnd, so does not need a duration attribute. It does need to 
     * override the base class abstract methods.
     * 
