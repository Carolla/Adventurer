...
/**
 *	The <code>Room</code> is the basic unit of the <code>Inn</code> (dungeon object 
 * container). In this case, there is only one <code>Room</code> (the "main" Room) in the 
 * <code>Inn</code>. 
 * <p>
 * Each (the) <code>Room</code> contains a description, and a collection of 
 * <code>Persons</code>--<code>Patron</code>s and the <code>Innkeeper</code>.
 *  The <code>Innkeeper</code> is always in the main <code>Room </code> of the 
 *  <code>Inn</code>. 
 *  
 * @author Alan Cline
 * @version <DL>
 * <DT>1.0	 Aug 30 2006		// Original version <DD>
 * <DT>2.0 Mar 25 2007		// Added serialization <DD>
 * <DT>3.0 May 20 2007		// Moved to common package for DgnBuild and DgnRun <DD>
 * <DT>3.1 May 26 2007		// Added non-default serialization for better flexibility in writing 
 * 					attributes separately, expecting to encrypt long text blocks to keep user from 
 * 					reading answers in the XML datafile.<DD>
 * <DT>4.0 Sep 29 2007		// Revised for DgnBuild and DgnRunner merged program. <DD> 
 * <DT>4.1 Feb 16 2008		// Added Affinity methods <DD>
 * <DT>4.2	 Jul 3 2008			// Final commenting for Javadoc compliance<DD>
 * </DL>
 */
public class Room
{
  ...
  * ++++++++++++++++++++++++++++++++++++++++++++++++++++++ */  
      ...
      * 
      * @param   npc	<code>Person</code> to add into the <code>Room</code>; 
      * 				can even be the <code>Innkeeper</code>.
      */
     public void add(Person npc)
     {
		...
		/** <code>Room</code> conntains all <code>Persons</code>, so it is responsible to 
		 * loop through all <code>Patrons</code> in the <code>Room</code>, and adjust 
		 * their affinities by the amount given. This method does not adjust the 
		 * <code>Innkeeper</code>'s affinity; <code>Patron</code> affinity only.
		 * 
		 * @param affin		amount to adjust the affinity of each <code>person</code>; 
		 * 			if affin is negative, <code>Patron</code>'s affinity is reduced 
		 */ 
	   ...
	   /**
	    * Checks if the <code>Innkeeper</code>, a special non-<code>Patron Person</code>, 
	    * is in the <code>Room</code>. He should always be (for now).
	    * 
	    ...
	    */
	     public Innkeeper getInnkeeper()
	     {
		  ...
		  /**
		   * Gets the total number of <code>Patron</code>s in the <code>Room</code> 
		   * (excluding <code>Innkeeper</code>).
		   *  
	     ...
	     /**
	      * Retrieves a <code>Person</code> from the <code>Room</code> by the 
	      * <code>Patron</code> (internal) number.
	      * 
		  * @param		nbr of the <code>Patron</code>, between 0 and number of 
		  * 				<code>Persons</code> in <code>Room</code> (including 
		  * 				<code>Innkeeper</code>).  
	    ...
	    */
		...
		/**
		 * Gives the <code>Room</code> description, and the far description of any 
		 * <code>Person</code> in the <code>Room</code>.
		 */
		public void look()
		{
		   ...
		   /**
	      * Removes a <code>Patron</code> from the <code>Room </code>.
	      * A <code>Patron</code> who is busy talking will not be removed.
	      * 
	    ...
	    { 
	     ...
	     /** 
	  	 ...
	  	 * 
	  	 * @param	desc		what the <code>Hero </code>sees when he LOOKs around the 
	  	 * 				<code>Room</code>.
	     */
...
//			/**
//	      * For DEBUGGING: Dump the attributes of the room: Name, Number, Description, and name of people within.
//	      */
//	     public void dump()
//	     {
