...
/**
 * This internal command causes a Patron to enter the Inn. The dungeon Inn and the Room is a common
 * reference contained in the Command base class, so is not needed to be passed in through the
 * arglist.
 * 
 * @author Alan Cline
 * @versionNov 5 2005 // Original <br>
 *             Jul 28 2007 // Add the randomized Patrons to init() <br>
 *             Oct 20 2007 // Updated with new Command package <br>
 * @see Command
 */
public class intCmdEnter extends Command
{
  ...
  /**
   * Puts a Patron into the Inn at the beginning of the game. This command cannot be called by the
   * User; it is called by the Class class in the CommandFactory. Uses fixed DELAY and DURATION
   * values.
   */
  public intCmdEnter()
  {
  ...
  /**
   * Retrieves the Patron object using the Patron's name, then puts him/her into the dungeon Inn for
   * the first time.
   * 
